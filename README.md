...
cd $HOME
git clone https://github.com/LinuxTeam98/TeleLinux.git
cd telegram-bot
./launch.sh install
./launch.sh # Will ask you for a phone number & confirmation code.
```

Enable more [`plugins`](https://github.com/LinuxTeam98/TeleLinux/tree/master/plugins)
-------------
...
Contact me
------------
You can contact me [via Telegram](https://telegram.me/sudo_TeleLinux) but if you have an issue please [open](https://github.com/LinuxTeam98/TeleLinux/issues) one.
